...
class IndexController extends Controller {
    ...
    {	//基地影视
        ...
        $base_heng=M('basevideo')->where('is_show=1 and is_main=0')->field('link_mobile,sltpath,mp4_mobile')->order('id desc,pubtime desc')->select();
    ...
    public function newsList(){
        $news5=M('news')->where('isshow=1')->order('id desc ,pubtime desc')->select();
