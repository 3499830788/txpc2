...
<div class="formbody"> 
    <div id="usual1" class="usual"> 
        ...
        <div id="tab1" class="tabson">
            ...
            <form action="<?php echo U('add')?>" method="post" enctype="multipart/form-data" id="fr">
                <ul class="forminfo">
                <li>
                    <div class="child_div">
                ...
                <li>
                    <div class="child_div">
                        <label>视频时长<b>*</b></label><input id="vTime" name="vTime" type="text" class="dfinput"  style="width:250px;"/><span style="line-height:40px; padding-left:20px;">（例如：1分30秒）</span>
                    </div>
                </li>
               <li>
                   <div class="child_div">
...
$(function(){
    ...
    $(".fb-btn").click(function(){
        ...
        var swf=$("#swf").val(),
            mp4 = $("#mp4").val(),
            vtime = $("#vTime").val();
            if($.trim(vtime).length == 0) return confirm("请填写视频时长。");
            if(!images()) return;
