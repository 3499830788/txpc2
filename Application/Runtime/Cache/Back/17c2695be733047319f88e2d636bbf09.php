...
<body>
    ...
    <div id="tab1" class="tabson">
        ...
        <form action="<?php echo U('scenesUpdata')?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="did" value="<?php echo ($sid["id"]); ?>">
            <ul class="forminfo">
                <li><label>信息分类<b>*</b></label>
                    <div class="vocation">
                        <select class="select1" name="classid">
                            <?php if(is_array($cate)): foreach($cate as $key=>$vo): if($vo['id']==$sid['cate']){?>
                ...
                <li style="margin-top:30px;"><label>&nbsp;</label><input name="" type="submit" class="fb-btn" value="确认保存"/></li>
            </ul>
        </form>
    </div>    
    </div> 
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        server: 'http://www.xpcjd.com/Back/Scenes/scenesUpdatase', //后台接收路径
        fileNumLimit: 300,
        fileSizeLimit: 5 * 1024 * 1024,    // 总文件大小5 M
        fileSingleSizeLimit: 1 * 1024 * 1024    // 单个文件1 M
    });
