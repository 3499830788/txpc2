...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a href="<?php echo U('newsAdd')?>"><span><img src="/Public/Back/src/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
                ...
                <!-- <td>4077</td> -->
                <td><a href="<?php echo U('Home/Index/news',array('id'=>$v['id']));?>" target="_blank">查看</a></td>
                <td><?php if($v["isshow"] == 1): ?>是<?php else: ?>否<?php endif; ?><td>
                <?php if($v["isshow"] == 0): ?><a href="<?php echo U('release',array('id'=>$v['id']))?>" class="tablelink">点击发布</a>
                <?php else: ?>
                <a href="<?php echo U('unlease',array('id'=>$v['id']))?>" class="tablelink">撤销发布</a><?php endif; ?> 
                <a href="<?php echo U('newsUpdate',array('id'=>$v['id'],'page'=>$_GET['p']))?>" class="tablelink">修改</a> 
