...
<body>
    ...
    <div id="usual1" class="usual"> 
        ...
        <div id="tab1" class="tabson">
            ...
            <form action="<?php echo U('serviceUpdata')?>" method="post" id="form" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $_GET['id'];?>" >
                <ul class="forminfo">
                    <li><label>完整标题<b>*</b></label><input name="title" type="text" class="dfinput" value="<?php echo ($data["title"]); ?>" style="width:518px;"/></li>
                    ...
                    <li><label>关键字<b>*</b></label><input name="tag" type="text" class="dfinput" value="<?php echo $data['tag']?>" style="width:518px;"/></li>
