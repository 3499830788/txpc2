    ...
    <div id="usual1" class="usual"> 
        <div class="itab">
      	...
      	<div id="tab1" class="tabson"> 
            <div class="formtext">Hi，<b><?php echo ($users["username"]); ?></b>，使用发布！</div>
            <form action="<?php echo U('newsUpdate')?>" method="post" id="form" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $_GET['id'];?>" >
                <input type="hidden" name="page" value="<?php echo $_GET['page'];?>" >
                <ul class="forminfo">
                    <li><label>完整标题<b>*</b></label><input name="title" value="<?php echo ($data["title"]); ?>" type="text" class="dfinput"  style="width:518px;"/></li>
                    ...
                    <li><label>内容详情<b>*</b></label>
                    	<div style="float:left;">
                            ...
                            <textarea id="editor_id" name="content" style="width:900px;height:450px;"><?php echo $data['content']?></textarea>
                        </div>
                    	<div style="clear:both;"></div>
                    </li>   
                    <li><label>关键字<b>*</b></label><input name="tag" value="<?php echo $data['tag']?>" type="text" class="dfinput"  style="width:518px;"/></li>   
                    <li><label>内容描述<b>*</b></label>
                        <textarea id="info" name="info" style="width:700px;height:80px; border:1px solid #CCC;" class="textinput"><?php echo $data['info']?></textarea>   
                        </li>
...
<script type="text/javascript">
    ...
    function imagesAjaxs(url){ // 详情图片ajax
        $.post("<?php echo U('Back/News/caijian');?>",{"url":url},function(data){
            if(data.status==1){
                alert("请在编译器在线图片里查看");
            }else{
                alert("上传失败");
