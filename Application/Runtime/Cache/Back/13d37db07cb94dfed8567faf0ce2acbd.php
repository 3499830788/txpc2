...
$(document).ready(function(){
    ...
    $("input[name='delid']").val();
    $("input[name='num']").val();
    $(".tip").fadeOut(100);
    });
	//allid
    $('input[name="allid"]').click(function(){
        $('.delcheckbox').prop("checked", $(this).is(':checked')); 
    });
});
</script>
<script>
...
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
        	<ul class="toolbar">
                <li><a href="<?php echo U('friendlinkAdd')?>"><span><img src="/Public/Back/src/images/t01.png" /></span>添加</a></li>
    ...
    <form action="<?php echo U('alldelete')?>" method="post" id="form2" >
        ...
        <table class="tablelist">
            ...
            <tbody>
            <?php if(is_array($friendlylink)): foreach($friendlylink as $key=>$v): ?><tr>
                    <td><input class='delcheckbox' name="ids[]" type="checkbox" value="<?php echo ($v["id"]); ?>" /></td>
                    <td><?php echo ($v["id"]); ?></td>
                    <td><span style="display:none;"><?php echo ($v["order"]); ?></span><span class="id"><?php echo ($v["order"]); ?></span></td>
                    <td><?php echo ($v["name"]); ?></td>
                    <td><?php echo ($v["add_time"]); ?></td>
                    <td> <a href="<?php echo U('friendlinkAdd',array('id'=>$v['id']))?>" class="tablelink">修改</a> 
                    <a style="cursor:pointer;" linkid="<?php echo $v['id']?>" page="<?php echo $_GET['p']?>" class="tablelink click delid"> 删除</a><td>
    ...
    <div class="tip">
        ...
        <form action="<?php echo U('del')?>" method="post" id="form1" >
            ...
            <input type="button"  class="sure" value="确定" id="sure" />&nbsp;
    ...
    <script>
    	$(document).ready(function(e) {
            ...
            $(".alldelete").click(function(){alert(1)
                var a=''
