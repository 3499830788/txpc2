...
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
        	<ul class="toolbar">
                <li><a href="<?php echo U('serviceAdd')?>"><span><img src="/Public/Back/src/images/t01.png" /></span>添加</a></li>
    ...
    <form action="<?php echo U('alldelete')?>" method="post" id="form2" >
        ...
        <table class="tablelist">
            ...
            <tbody>
            <?php if(is_array($service)): foreach($service as $key=>$v): ?><tr>
                    ...
                    <a href="<?php echo U('serviceUpdata',array('id'=>$v['id'],'page'=>$_GET['p']))?>" class="tablelink">修改</a> 
