...
<body>
    ...
    <div class="tools">
    	<ul class="toolbar">
            <li><a href="<?php echo U('Back/Basevideo/baseAdd');?>"><span><img src="/Public/Back/src/images/t01.png" /></span>添加</a></li>
    ...
    <form action="<?php echo U('Back/Basevideo/alldelete');?>" method="post" id="form2" >
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                    ...
                    <?php if($vo["is_show"] == 1): ?><td>是</td>
                    <?php else: ?>
                    <td>否</td><?php endif; ?>
                    <?php if($vo["is_main"] == 1): ?><td>是</td>
                    <?php else: ?>
                    <td>否</td><?php endif; ?>
                    <td>
                    <?php if($vo["is_show"] == 0): ?><a href="<?php echo U('release',array('id'=>$vo['id']))?>" class="tablelink">点击发布</a>
                    <?php else: ?>
                    <a href="<?php echo U('unlease',array('id'=>$vo['id']))?>" class="tablelink">撤销发布</a><?php endif; ?>
                    <a href="<?php echo U('baseUpdata',array('id'=>$vo['id'],'page'=>$_GET['p']))?>" class="tablelink">修改</a>
                    <?php if($vo["is_main"] == 0): ?><a href="<?php echo U('update',array('id'=>$vo['id'],'page'=>$_GET['p']))?>" class="tablelink">设为主视频</a>
                    <?php else: ?>
                    <a href="#" class="tablelink">已被设置为主视频</a><?php endif; ?>
                     <a style="cursor:pointer;" linkid="<?php echo ($vo["id"]); ?>" page="" class="tablelink click delid"> 删除</a>
                    </td> 
