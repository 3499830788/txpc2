...
<div class="formbody"> 
    <div id="usual1" class="usual"> 
        ...
        <div id="tab1" class="tabson">
            ...
            <form action="<?php echo U('baseUpdata')?>" method="post" enctype="multipart/form-data" id="fr">
            ...
            <input type="hidden" name="page" value="<?php echo $_GET['page'];?>" >
                ...
                <div>
                    <li>
                        <div class="child_div mrlf10">
                            <label>完整标题<b>*</b></label><input id="title" name="title" type="text" class="dfinput"  style="width:250px;" value="<?php echo ($show["title"]); ?>" />
                        </div>
                        <div class="child_div">
                            <label>缩略图<b>*</b></label>
                ...
                <li><label>淘宝swf地址<b>*</b></label><input name="link_mobile" type="text" class="dfinput"  style="width:518px;" value="<?php echo ($show["link_mobile"]); ?>" id="swf"/> (直接复制淘宝视频连接即可)</li>
                <li><label>淘宝MP4地址<b>*</b></label><input name="mp4_mobile" type="text" class="dfinput"  style="width:518px;" value="<?php echo ($show["mp4_mobile"]); ?>" id="mp4"/> (直接复制淘宝视频连接即可)</li>
