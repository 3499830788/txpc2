...
function browserRedirect() {
    ...
    if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM) {
        ...
        window.location.href = 'http://www.xpcjd.com/video2.html';
    }
}
browserRedirect(); 	
</script>
...
<div id="video-container">
	...
	<p class="v-time"><?php echo ($video2["pubtime"]); ?></p>
	<!--视频-->
	<video width="100%" height="210" src="<?php echo ($video2["mp4_mobile"]); ?>" controls="controls">
