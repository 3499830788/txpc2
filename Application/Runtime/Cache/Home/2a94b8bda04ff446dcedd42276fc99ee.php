...
<head>
<meta charset="UTF-8">
<title><?php echo "橡皮擦-杭州影视基地--橡皮擦淘宝实景基地";?></title>
<meta name="description" content="杭州橡皮擦淘宝实景基地为企业拍摄宣传片、微电影、广告片等提供专业摄影摄像租赁，杭州影视基地、影视器材设备等租赁。杭州橡皮擦淘宝实景基地，杭州专业影视器材租赁公司，预约热线15394243344" />
<meta name="keywords" content="橡皮擦实景基地,杭州拍摄基地,杭州实景基地,杭州影视基地,杭州淘宝摄影,杭州摄影棚,杭州影视器材租赁,摄影摄像租赁"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
<link rel="stylesheet" type="text/css" href="/Public/Home/src/bootstrap/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="/Public/Home/src/swiper/swiper-3.4.1.min.css">
...
<link rel="stylesheet" type="text/css" href="/Public/Home/src/css/index.css">
<link rel="stylesheet" type="text/css" href="/Public/Home/src/css/video-js.css">
<link rel="stylesheet" type="text/css" href="/Public/Home/src/css/vim.css">
...
function browserRedirect() {
    ...
    if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM) {
        window.location.href = 'http://www.xpcjd.com/App/index.html';
    } else {
    }
}
browserRedirect(); 	
</script>
<script src="/Public/Home/src/swiper/swiper-3.4.1.jquery.min.js"></script>
<title>橡皮擦-首页</title>
</head>
<body>
<!--header start-->
		...
		<div class="container-fluid tg clear">
			...
			<div class="tgl collapse navbar-collapse" id="bs-example-navbar-collapse-1" role="navigation">	
				<ul class="nav navbar-nav navbar-right">
					<li><a class="active" href="http://www.xpcjd.com">
						<span></span>首页
					</a></li>
...
<!--banner start-->
<div class="banner">
	<img style="width:100%" src="/Public/Home/src/img/081826472410.jpg" alt="橡皮檫五星级摄影基地">
</div>
<!--banner end-->
<section class="bgf">
	<div class="container-fluid">
		<div class="fs28 fw tg iTile mt40">
			<img src="/Public/Home/src/img/s1.jpg" alt="基地视频">
			<div class="hrt"></div>
			<div class="hrb"></div>
		</div>
	</div>
...
<section  class="ptb70">
	...
	<!--视频-->
	<div class="video-js-box vim-css vjs-paused" id="video-container">
		<video id="xpc_video" class="video-js vjs-paused" preload="auto" poster="" webkit-playsinline="" src="" style="visibility: visible;width:100%; height: 100%;">
				<source src="" type="video/mp4">
		</video>
		<input type="hidden" name="" id="mp4-url" value="<?php echo ($basevideo["mp4_mobile"]); ?>" />
	</div>
	<div class="row mt20 v-list">
		<div class="swiper-container">
	  		<div class="swiper-wrapper">
	  		    <?php if(is_array($base_heng)): foreach($base_heng as $key=>$vo): ?><div class="swiper-slide col-xs-4 v-tab" data-mp4="<?php echo ($vo["mp4_mobile"]); ?>"><img src="http://www.xpcjd.com/<?php echo ($vo["sltpath"]); ?>" /></div><?php endforeach; endif; ?>
			</div>
		</div>
...
<!--介绍视频 end-->
<div class="step1"><img src="/Public/Home/src/img/291410008494.jpg"></div>
<!--场景介绍 strat-->
<section class="mt70 pb70">
	<div class="CJ">
		<div class="container-fluid">
			<div class="fs28 fw tg iTile mt40">
				<img src="/Public/Home/src/img/s2.jpg" alt="场景介绍">
				<div class="hrt"></div>
				<div class="hrb"></div>
			</div>
			<div class="row">
			...
			<div class="more">
				<p><a href="scenes.html">更多作品展示 READMORE</a></p>
				<div></div>
			</div>
		</div>
	</div>
...
<section class="bgf ptb70">
	<div class="container-fluid">
		<div class="fs28 fw tg iTile mb20">
			<img src="/Public/Home/src/img/s3.jpg" alt="服务案例">
			<div class="hrt"></div>
			<div class="hrb"></div>
		</div>
		<div class="mr_frUl row">
			<div class="swiper-container">
		  		<div class="swiper-wrapper">
		  		<?php if(is_array($video)): foreach($video as $key=>$vi): ?><div class="swiper-slide col-xs-4 vPlay" data-user="佚名" data-time="<?php echo ($vi["pubtime"]); ?>" data-duration="<?php echo ($vi["vTime"]); ?>" data-url="<?php echo ($vi["link_mobile"]); ?>" data-title="<?php echo ($vi["title"]); ?>">
                        <div class="viimg">
...
<!--服务案例 end-->
<!--基地服务 start-->
<section class="pb70 bgf">
	<div class="container-fluid JD">
		<div class="fs28 fw tg iTile mb20">
			<img src="/Public/Home/src/img/s4.jpg" alt="基地服务">
			<div class="hrt"></div>
			<div class="hrb"></div>
		</div>
		<div class="row">
		...
		<div class="more">
			<p><a href="service.html">更多服务 READMORE</a></p>
			<div></div>
		</div>
	</div>
</section>
<!--基地服务 end-->
<div class="step2"><img src="/Public/Home/src/img/261102201091.jpg"></div>
<!--新闻中心 start-->
<section class="bgf">
	<div class="container-fluid">
		<div class="fs28 fw tg iTile mt40">
			<img src="/Public/Home/src/img/s5.jpg" alt="新闻中心">
			<div class="hrt"></div>
			<div class="hrb"></div>
		</div>
	</div>
...
<section class="mt70 pb70">
	<div class="container-fluid WZ">
		<div class="row">
			<?php if(is_array($news1)): foreach($news1 as $key=>$vo): ?><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mt20">
				<div class="wzMian">
					<div class="row">
						<a href="<?php echo U('info',array('ids'=>$vo['id']));?>">
						<div class="col-xs-4 wzLeft">
							<img src="<?php echo ($vo["sltpath"]); ?>" alt="">
						</div>
						<div class="col-xs-8 wzRight">
							<p class="wzTitle t-ellipsis"><?php echo (mb_substr(strip_tags($vo["title"]),0,25,'utf-8')); ?></p>
							<p class="wzContent t-ellipsis"><?php echo ($vo["info"]); ?></p>
						</div>
						</a>
					</div>
				</div>
			</div><?php endforeach; endif; ?>
			<?php if(is_array($news2)): foreach($news2 as $key=>$vo): ?><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mt20">
				<div class="wzMian">
					<div class="row">
						<a href="<?php echo U('info',array('ids'=>$vo['id']));?>">
							<div class="col-xs-4 wzLeft">
		...
		<div class="more">
			<p><a href="newList.html">更多新闻 READMORE</a></p>
			<div></div>
		</div>
	</div>
</section>
    ...
    <div class="links">
    	<div class="container-fluid tg">
    		<div class="tgl dline">
    			<ul>
		    		<li>友情链接：</li>
		    		<?php if(is_array($friendlink)): foreach($friendlink as $key=>$vo): ?><li><a href="<?php echo ($vo["link"]); ?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; ?>
		    	</ul>
    		</div>
    	</div>
    </div>
